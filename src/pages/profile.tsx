...
// const copyToClipboard = (text : any) => (evt : any) => {
...
//   handleContentScrolled: (boolean : boolean) => void;
// };
...
//   const onScroll = useCallback((reachedTop: any) => {
...
//     supervisorsPromise.then((data: any) => {
//       setContactItems(service.getContactItems(data));
//     });
//     profileDataPromise.then((data: any) => {
//       setProfileData(data);
//       setSavedData(data);
//     });
